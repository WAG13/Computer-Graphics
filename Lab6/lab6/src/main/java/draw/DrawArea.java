...
import algo.ConvexHullProcessor;
...
public class DrawArea extends JComponent {
    ...
    private final int PAINT_RADIUS = 2;
    ...
    private void drawPoint(Point e) {
        graphics2D.fillOval(e.x-PAINT_RADIUS, e.y-PAINT_RADIUS, PAINT_RADIUS*2, PAINT_RADIUS*2);
        repaint();
    }

    private void drawPoint(Integer i) {
        graphics2D.fillOval(points.get(i).x-PAINT_RADIUS, points.get(i).y-PAINT_RADIUS, PAINT_RADIUS*2, PAINT_RADIUS*2);
