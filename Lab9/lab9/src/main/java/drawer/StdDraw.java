...
/**
 *  The {@code drawer.StdDraw} class provides a basic capability for
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code drawer.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">drawer.StdDraw.java</a>
 ...
 *           drawer.StdDraw.setPenRadius(0.05);
 *           drawer.StdDraw.setPenColor(drawer.StdDraw.BLUE);
 *           drawer.StdDraw.point(0.5, 0.5);
 *           drawer.StdDraw.setPenColor(drawer.StdDraw.MAGENTA);
 *           drawer.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code drawer.StdDraw.line()} and {@code drawer.StdDraw.point()}
 *  draw lines and points; the methods {@code drawer.StdDraw.setPenRadius()}
 *  and {@code drawer.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code drawer.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   drawer.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code drawer.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code drawer.StdDraw.setPenColor(drawer.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code drawer.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code drawer.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   drawer.StdDraw.setFont(font);
 *   drawer.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code drawer.StdDraw.clear(drawer.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   drawer.StdDraw.setScale(-2, +2);
 *   drawer.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       drawer.StdDraw.clear();
 *       drawer.StdDraw.filledCircle(x, y, 0.05);
 *       drawer.StdDraw.filledCircle(-x, -y, 0.05);
 *       drawer.StdDraw.show();
 *       drawer.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code drawer.StdDraw.BLACK}, {@code drawer.StdDraw.BLUE}, {@code drawer.StdDraw.CYAN},
     * {@code drawer.StdDraw.DARK_GRAY}, {@code drawer.StdDraw.GRAY}, {@code drawer.StdDraw.GREEN},
     * {@code drawer.StdDraw.LIGHT_GRAY}, {@code drawer.StdDraw.MAGENTA}, {@code drawer.StdDraw.ORANGE},
     * {@code drawer.StdDraw.PINK}, {@code drawer.StdDraw.RED}, {@code drawer.StdDraw.WHITE}, and
     * {@code drawer.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to drawer.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to drawer.StdDraw)
        try {
            URL url = drawer.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
